import type { ResolvedTheme, ThemeColorKey } from "@/services/theme/types";

function isObject(value: unknown): value is Record<string, unknown> {
  return typeof value === "object" && value !== null;
}

export function getThemeColorByPath(theme: unknown, keyPath: ThemeColorKey | string): string {
...
function setThemeColorByPath(theme: Record<string, unknown>, keyPath: string, value: string): void {
