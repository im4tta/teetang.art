...
export const [MIN_DISTANCE_METERS, MAX_DISTANCE_METERS, DEFAULT_DISTANCE_METERS] = [
  100, 20_000_000, 4_000,
];

export const REPO_URL = import.meta.env.VITE_REPO_URL ?? "https://github.com/im4tta/teetang.art";
export const REPO_API_URL =
  import.meta.env.VITE_REPO_API_URL ?? "https://api.github.com/repos/im4tta/teetang.art";
...
export const FONT_OPTIONS: FontOption[] = [
  { value: "Moul", label: "ម Moul (Khmer)" },
  { value: "Battambang", label: "ប Battambang (Khmer)" },
  { value: "Suwannaphum", label: "ស Suwannaphum (Khmer)" },
  { value: "Kantumruy Pro", label: "ក Kantumruy Pro (Khmer)" },
  { value: "Hanuman", label: "ហ Hanuman (Khmer)" },
  { value: "Koh Santepheap", label: "ខ Koh Santepheap (Khmer)" },
  { value: "Preahvihear", label: "ព Preahvihear (Khmer)" },
  { value: "Siemreap", label: "ស Siemreap (Khmer)" },
  { value: "Noto Serif Khmer", label: "ន Noto Serif Khmer (Khmer)" },
  { value: "Dangrek", label: "ដ Dangrek (Khmer)" },
  { value: "Bokor", label: "ប Bokor (Khmer)" },
  { value: "Chenla", label: "ច Chenla (Khmer)" },
  { value: "Content", label: "ក Content (Khmer)" },
  { value: "Fasthand", label: "ហ Fasthand (Khmer)" },
  { value: "Moulpali", label: "ម Moulpali (Khmer)" },
  { value: "Koulen", label: "ក Koulen (Khmer)" },
