import { MAX_PIXELS, MAX_SIDE, OUTPUT_DPI } from "@/services/poster/renderer/constants";
import type { CanvasSize } from "@/services/poster/types";

export function resolveCanvasSize(widthInches: number, heightInches: number): CanvasSize {
