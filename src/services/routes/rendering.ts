...
import { projectMarkerToCanvas } from "@/services/markers/projection";
import { ROUTE_DASH_PATTERN } from "@/services/routes/constants";
import type { Route } from "@/services/routes/types";

export type RoutePointProjector = (lat: number, lon: number) => { x: number; y: number } | null;
