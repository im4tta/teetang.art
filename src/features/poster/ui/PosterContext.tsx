...
export const DEFAULT_FORM: PosterForm = {
  ...
  includeBuildings: false, includeWater: true, includeParks: true,
  ...
  snapToRoads: true, poiSchools: false, poiHospitals: false, poiMarkets: false, poiBanks: false, poiRestaurants: false,
...
const MAP_LAYER_KEYS = [
  ...
  "includeRoadMinorLow", "includeRoadOutline",
] as const;
...
export function PosterProvider({ children }: { children: ReactNode }) {
  ...
  const mapStyleOpts = useMemo(
    ...
    [
      ...
      state.form.includeRoadOutline, state.form.distance, state.form.tileProvider,
    ],
  );
  ...
  const mapStyleOpts2 = useMemo(
    ...
    [
      ...
      state.form.includeParks, state.form.includeAeroway, state.form.includeRail,
      state.form.includeRoads, state.form.includeRoadPath, state.form.includeRoadMinorLow,
      state.form.includeRoadOutline, state.form.distance2, state.form.distance, state.form.tileProvider,
    ],
  );
