...
export default function StartupLocationModal({ onComplete }: StartupLocationModalProps) {
  ...
  const applyResolvedLocation = (location: PendingLocation | null) => {
    ...
    dispatch({
      ...
      location: {
        ...
        shortLabel: location.shortLabel || location.label.split(",")[0]?.trim() || location.label,
        city: location.city,
    ...
    void (async () => {
      ...
      try {
        ...
        const pending: PendingLocation = {
          ...
          shortLabel: resolved.shortLabel || resolved.label.split(",")[0]?.trim() || resolved.label,
          lat,
          lon,
  ...
  return (
    ...
    >
      <div className="startup-location-logo-wrap" aria-hidden="true">
        ...
        <p className="startup-location-app-name">Tee Tang Art</p>
      </div>
