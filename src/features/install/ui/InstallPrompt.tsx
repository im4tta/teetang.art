      ...
      <>
        <div className="install-prompt" role="complementary">
          <span className="install-prompt-text">
            <MobileIcon className="install-prompt-mobile-icon" aria-hidden="true" />
            Install Tee Tang Art for faster access and a better experience.
          </span>
      ...
      <>
        <div className="install-prompt" role="complementary">
          <span className="install-prompt-text">
            ...
            then <strong>Add to Home Screen</strong> for faster access and a better experience.
          </span>
          <div className="install-prompt-actions">
            <button type="button" className="install-prompt-dismiss" onClick={dismiss}>
              Maybe later
    ...
    return (
      <>
        <div className="install-prompt" role="complementary">
          <span className="install-prompt-text">
            <MobileIcon className="install-prompt-mobile-icon" aria-hidden="true" />
            For faster access and a better experience, install Tee Tang Art from your browser menu:
