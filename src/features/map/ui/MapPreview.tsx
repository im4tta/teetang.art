...
import { MAP_CENTER_SYNC_EPSILON, MAP_ZOOM_SYNC_EPSILON } from "@/features/map/infrastructure";
import { useRadiusLayer } from "@/features/map/application/useRadiusLayer";
import { useMapInteractivity } from "@/features/map/application/useMapInteractivity";
import { applyIncrementalStyleUpdate } from "@/features/map/infrastructure/styleUtils";
...
export default function MapPreview({
  ...
  useEffect(() => {
    ...
    if (!map.isStyleLoaded()) {
      const applyWhenReady = () => { map.setStyle(style); prevStyleRef.current = style; };
