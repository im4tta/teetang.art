...
import { normalizePosterSizeValue, resolveLayoutIdForSize, formatLayoutCm } from "@/services/layout/layoutMatcher";
import { getLayoutOption, layoutOptions } from "@/services/layout/layoutRepository";
import { MIN_POSTER_CM, MAX_POSTER_CM, MIN_DISTANCE_METERS, MAX_DISTANCE_METERS, LAYOUT_MATCH_TOLERANCE_CM } from "@/services/config";
